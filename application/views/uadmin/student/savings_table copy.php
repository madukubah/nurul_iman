                                    ...
                                    ?>
                                            <?php 
                                                    switch( $value['type'] )
                                                    {
                                                        // case "link" :
                                                        //         $value["data"] = $row;
                                                        //         echo $this->load->view('templates/actions/link', $value , false); 
                                                        //     break;
                                                        // case "modal_delete" :
                                                        //         $value["data"] = $row;
                                                        //         echo $this->load->view('templates/actions/modal_delete', $value, true ); 
                                                        //     break;
                                                        case "modal_form" :
                                                                $value["data"] = $row;
                                                                $this->load->view('templates/actions/modal_form', $value, false ); 
                                                            break;
                                                        // case "modal_form_multipart" :
                                                        //         $value["data"] = $row;
                                                        //         echo $this->load->view('templates/actions/modal_form_multipart', $value, true ); 
                                                        //     break;
                                                        // case "button_dropdowns" :
                                                        //         $value["data"] = $row;
                                                        //         echo $this->load->view('templates/actions/button_dropdown', $value, true ); 
                                                        //     break;
                                                    }
                                            ?>
                                    <?php 
